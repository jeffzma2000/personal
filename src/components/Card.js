    ...
    return(
        <div className="card">
            ...
            <div className="card-body">
                ...
                <p className="card-text post-preview">{shortenText(tagToText(props.post.content), 0, 200) + '...'}</p>
                <a href={props.post.link} target="_blank" className="btn btn-link-grey">Read this article on Medium.com</a>
            </div>
        </div>
    )
}
